...
DB_SCHEMA_ALUMNOS = {
    "tabla": "alumnos",
    "campos": {
        "legajo": "string, clave primaria",
        "nombre": "string",
        "carrera": "string",
        "email": "string",
        "notas": "list[float]",
        "entregas": "dict[str, bool]",
    },
    "nota": "Schema simplificado para fines educativos.",
}
...
def buscar_alumno(legajo: str) -> dict[str, Any]:
    ...
    Returns:
        Datos públicos del alumno para la demo. No devuelve información sensible.
    """
...
def schema_alumnos() -> str:
    """Devuelve un schema simplificado de la tabla alumnos."""
    return json.dumps(DB_SCHEMA_ALUMNOS, ensure_ascii=False, indent=2)
